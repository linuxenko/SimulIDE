...
const QMetaObject LogicInput::staticMetaObject = {
    { &Component::staticMetaObject, qt_meta_stringdata_LogicInput.data,
      qt_meta_data_LogicInput,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *LogicInput::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_LogicInput.stringdata0))
        return static_cast<void*>(const_cast< LogicInput*>(this));
    if (!strcmp(_clname, "eElement"))
        return static_cast< eElement*>(const_cast< LogicInput*>(this));
