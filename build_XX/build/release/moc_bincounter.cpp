...
const QMetaObject BinCounter::staticMetaObject = {
    { &LogicComponent::staticMetaObject, qt_meta_stringdata_BinCounter.data,
      qt_meta_data_BinCounter,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *BinCounter::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_BinCounter.stringdata0))
        return static_cast<void*>(const_cast< BinCounter*>(this));
    if (!strcmp(_clname, "eBinCounter"))
        return static_cast< eBinCounter*>(const_cast< BinCounter*>(this));
