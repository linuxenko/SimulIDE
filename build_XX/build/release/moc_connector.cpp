...
#include "../../../src/gui/circuitwidget/connector.h"
...
QT_MOC_LITERAL(3, 20, 3), // "yes"
QT_MOC_LITERAL(4, 24, 6), // "remove"
QT_MOC_LITERAL(5, 31, 4), // "move"
QT_MOC_LITERAL(6, 36, 5), // "delta"
QT_MOC_LITERAL(7, 42, 11), // "setSelected"
QT_MOC_LITERAL(8, 54, 9), // "pointList"
QT_MOC_LITERAL(9, 64, 10), // "startpinid"
QT_MOC_LITERAL(10, 75, 8), // "endpinid"
QT_MOC_LITERAL(11, 84, 7) // "enodeid"

    },
    "Connector\0selected\0\0yes\0remove\0move\0"
    "delta\0setSelected\0pointList\0startpinid\0"
    "endpinid\0enodeid"
};
...
void Connector::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->move((*reinterpret_cast< QPointF(*)>(_a[1]))); break;
        ...
        {
            typedef void (Connector::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Connector::selected)) {
                *result = 0;
            }
        }
    }
        ...
        case 3: *reinterpret_cast< QString*>(_v) = _t->enodId(); break;
        default: break;
        }
        ...
        case 3: _t->setEnodId(*reinterpret_cast< QString*>(_v)); break;
        default: break;
        }
...
const QMetaObject Connector::staticMetaObject = {
    { &Component::staticMetaObject, qt_meta_stringdata_Connector.data,
...
// SIGNAL 0
void Connector::selected(bool _t1)
{
