...
#include "../../../src/gui/circuitwidget/chip.h"
...
const QMetaObject Chip::staticMetaObject = {
    { &Component::staticMetaObject, qt_meta_stringdata_Chip.data,
      qt_meta_data_Chip,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Chip::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Chip.stringdata0))
        return static_cast<void*>(const_cast< Chip*>(this));
    if (!strcmp(_clname, "eElement"))
        return static_cast< eElement*>(const_cast< Chip*>(this));
