...
#include "../../../src/gui/editorwidget/codeeditorwidget.h"
...
struct qt_meta_stringdata_CodeEditorWidget_t {
    QByteArrayData data[4];
    char stringdata0[37];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_CodeEditorWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CodeEditorWidget_t qt_meta_stringdata_CodeEditorWidget = {
    {
QT_MOC_LITERAL(0, 0, 16), // "CodeEditorWidget"
QT_MOC_LITERAL(1, 17, 10), // "setVisible"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 7) // "visible"

    },
    "CodeEditorWidget\0setVisible\0\0visible"
};
...
const QMetaObject CodeEditorWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_CodeEditorWidget.data,
      qt_meta_data_CodeEditorWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CodeEditorWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CodeEditorWidget.stringdata0))
