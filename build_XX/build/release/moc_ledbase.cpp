...
const QMetaObject LedBase::staticMetaObject = {
    { &Component::staticMetaObject, qt_meta_stringdata_LedBase.data,
      qt_meta_data_LedBase,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *LedBase::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_LedBase.stringdata0))
        return static_cast<void*>(const_cast< LedBase*>(this));
    if (!strcmp(_clname, "eLed"))
        return static_cast< eLed*>(const_cast< LedBase*>(this));
