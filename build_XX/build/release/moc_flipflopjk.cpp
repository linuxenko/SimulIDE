...
const QMetaObject FlipFlopJK::staticMetaObject = {
    { &LogicComponent::staticMetaObject, qt_meta_stringdata_FlipFlopJK.data,
      qt_meta_data_FlipFlopJK,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *FlipFlopJK::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FlipFlopJK.stringdata0))
        return static_cast<void*>(const_cast< FlipFlopJK*>(this));
    if (!strcmp(_clname, "eFlipFlopJK"))
        return static_cast< eFlipFlopJK*>(const_cast< FlipFlopJK*>(this));
