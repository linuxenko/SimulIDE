/****************************************************************************
** Meta object code from reading C++ file 'relay-spst.h'
**
...
#include "../../../src/gui/circuitwidget/components/relay-spst.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'relay-spst.h' doesn't include <QObject>."
...
const QMetaObject RelaySPST::staticMetaObject = {
    { &RelayBase::staticMetaObject, qt_meta_stringdata_RelaySPST.data,
      qt_meta_data_RelaySPST,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *RelaySPST::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_RelaySPST.stringdata0))
        return static_cast<void*>(const_cast< RelaySPST*>(this));
    return RelayBase::qt_metacast(_clname);
}

int RelaySPST::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = RelayBase::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    return _id;
}
