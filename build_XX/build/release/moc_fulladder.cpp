/****************************************************************************
** Meta object code from reading C++ file 'fulladder.h'
**
...
#include "../../../src/gui/circuitwidget/components/fulladder.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'fulladder.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(6, 68, 9) // "Out_Imped"
    ...
    "FullAdder\0Input_High_V\0Input_Low_V\0"
...
void FullAdder::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        FullAdder *_t = static_cast<FullAdder *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
...
const QMetaObject FullAdder::staticMetaObject = {
    { &LogicComponent::staticMetaObject, qt_meta_stringdata_FullAdder.data,
      qt_meta_data_FullAdder,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *FullAdder::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FullAdder.stringdata0))
        return static_cast<void*>(const_cast< FullAdder*>(this));
    if (!strcmp(_clname, "eFullAdder"))
        return static_cast< eFullAdder*>(const_cast< FullAdder*>(this));
