...
const QMetaObject SevenSegment::staticMetaObject = {
    { &Component::staticMetaObject, qt_meta_stringdata_SevenSegment.data,
      qt_meta_data_SevenSegment,  qt_static_metacall, qt_meta_extradata_SevenSegment, Q_NULLPTR}
};
...
void *SevenSegment::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SevenSegment.stringdata0))
        return static_cast<void*>(const_cast< SevenSegment*>(this));
    if (!strcmp(_clname, "eElement"))
        return static_cast< eElement*>(const_cast< SevenSegment*>(this));
