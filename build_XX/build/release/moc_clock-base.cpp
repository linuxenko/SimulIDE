...
void ClockBase::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ClockBase::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ClockBase::freqChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject ClockBase::staticMetaObject = {
    { &LogicInput::staticMetaObject, qt_meta_stringdata_ClockBase.data,
      qt_meta_data_ClockBase,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ClockBase::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ClockBase.stringdata0))
        return static_cast<void*>(const_cast< ClockBase*>(this));
