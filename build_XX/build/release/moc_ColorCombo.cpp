...
#include "../../../src/gui/QPropertyEditor/ColorCombo.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ColorCombo_t, stringdata0) + ofs \
...
QT_MOC_LITERAL(3, 27, 5) // "index"
    ...
    "ColorCombo\0currentChanged\0\0index"
};
...
void ColorCombo::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ColorCombo *_t = static_cast<ColorCombo *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
void *ColorCombo::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ColorCombo.stringdata0))
