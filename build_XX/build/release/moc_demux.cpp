...
#include "../../../src/gui/circuitwidget/components/demux.h"
...
QT_MOC_LITERAL(1, 6, 12), // "Input_High_V"
QT_MOC_LITERAL(2, 19, 11), // "Input_Low_V"
QT_MOC_LITERAL(3, 31, 11), // "Input_Imped"
QT_MOC_LITERAL(4, 43, 10), // "Out_High_V"
QT_MOC_LITERAL(5, 54, 9), // "Out_Low_V"
QT_MOC_LITERAL(6, 64, 9), // "Out_Imped"
QT_MOC_LITERAL(7, 74, 8), // "Inverted"
QT_MOC_LITERAL(8, 83, 8) // "Tristate"

    },
    "Demux\0Input_High_V\0Input_Low_V\0"
...
const QMetaObject Demux::staticMetaObject = {
    { &LogicComponent::staticMetaObject, qt_meta_stringdata_Demux.data,
      qt_meta_data_Demux,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Demux::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Demux.stringdata0))
        return static_cast<void*>(const_cast< Demux*>(this));
    if (!strcmp(_clname, "eDemux"))
        return static_cast< eDemux*>(const_cast< Demux*>(this));
