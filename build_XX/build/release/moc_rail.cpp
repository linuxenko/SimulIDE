...
const QMetaObject Rail::staticMetaObject = {
    { &Component::staticMetaObject, qt_meta_stringdata_Rail.data,
      qt_meta_data_Rail,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Rail::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Rail.stringdata0))
        return static_cast<void*>(const_cast< Rail*>(this));
    if (!strcmp(_clname, "eElement"))
        return static_cast< eElement*>(const_cast< Rail*>(this));
