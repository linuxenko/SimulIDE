...
#include "../../../src/gui/circuitwidget/components/meter.h"
...
const QMetaObject Meter::staticMetaObject = {
    { &Component::staticMetaObject, qt_meta_stringdata_Meter.data,
...
void *Meter::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "eResistor"))
        return static_cast< eResistor*>(const_cast< Meter*>(this));
