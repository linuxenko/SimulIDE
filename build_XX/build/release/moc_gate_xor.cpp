/****************************************************************************
** Meta object code from reading C++ file 'gate_xor.h'
**
...
#include "../../../src/gui/circuitwidget/components/gate_xor.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'gate_xor.h' doesn't include <QObject>."
...
const QMetaObject XorGate::staticMetaObject = {
    { &Gate::staticMetaObject, qt_meta_stringdata_XorGate.data,
      qt_meta_data_XorGate,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *XorGate::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_XorGate.stringdata0))
        return static_cast<void*>(const_cast< XorGate*>(this));
