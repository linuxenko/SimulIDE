...
const QMetaObject OpAmp::staticMetaObject = {
    { &Component::staticMetaObject, qt_meta_stringdata_OpAmp.data,
      qt_meta_data_OpAmp,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *OpAmp::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_OpAmp.stringdata0))
        return static_cast<void*>(const_cast< OpAmp*>(this));
    if (!strcmp(_clname, "eOpAmp"))
        return static_cast< eOpAmp*>(const_cast< OpAmp*>(this));
