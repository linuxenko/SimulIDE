...
#include "../../../src/gui/circuitwidget/components/keypad.h"
...
QT_MOC_LITERAL(3, 15, 4), // "Rows"
QT_MOC_LITERAL(4, 20, 4), // "Cols"
QT_MOC_LITERAL(5, 25, 10) // "Key_Labels"

    },
    "KeyPad\0remove\0\0Rows\0Cols\0Key_Labels"
};
...
static const uint qt_meta_data_KeyPad[] = {
 ...
 // properties: name, type, flags
       ...
       5, QMetaType::QString, 0x00195003,
...
void KeyPad::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: *reinterpret_cast< int*>(_v) = _t->cols(); break;
        case 2: *reinterpret_cast< QString*>(_v) = _t->keyLabels(); break;
        default: break;
        }
        ...
        case 1: _t->setCols(*reinterpret_cast< int*>(_v)); break;
        case 2: _t->setKeyLabels(*reinterpret_cast< QString*>(_v)); break;
        default: break;
        }
...
const QMetaObject KeyPad::staticMetaObject = {
    { &Component::staticMetaObject, qt_meta_stringdata_KeyPad.data,
...
void *KeyPad::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "eElement"))
        return static_cast< eElement*>(const_cast< KeyPad*>(this));
