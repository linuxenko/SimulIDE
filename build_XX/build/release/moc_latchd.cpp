...
QT_MOC_LITERAL(12, 110, 7), // "Trigger"
QT_MOC_LITERAL(13, 118, 4), // "None"
QT_MOC_LITERAL(14, 123, 5), // "Clock"
QT_MOC_LITERAL(15, 129, 8) // "InEnable"

    },
    "LatchD\0remove\0\0Input_High_V\0Input_Low_V\0"
    "Input_Imped\0Out_High_V\0Out_Low_V\0"
    "Out_Imped\0Channels\0Tristate\0Inverted\0"
    "Trigger\0None\0Clock\0InEnable"
};
...
static const uint qt_meta_data_LatchD[] = {
 ...
 // enum data: key, value
      13, uint(LatchD::None),
      14, uint(LatchD::Clock),
      15, uint(LatchD::InEnable),
...
void LatchD::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 9: *reinterpret_cast< Trigger*>(_v) = _t->trigger(); break;
        default: break;
        }
        ...
        case 9: _t->setTrigger(*reinterpret_cast< Trigger*>(_v)); break;
        default: break;
        }
...
const QMetaObject LatchD::staticMetaObject = {
    { &LogicComponent::staticMetaObject, qt_meta_stringdata_LatchD.data,
      qt_meta_data_LatchD,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *LatchD::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_LatchD.stringdata0))
        return static_cast<void*>(const_cast< LatchD*>(this));
    if (!strcmp(_clname, "eLatchD"))
        return static_cast< eLatchD*>(const_cast< LatchD*>(this));
