...
const QMetaObject CapacitorBase::staticMetaObject = {
    { &Component::staticMetaObject, qt_meta_stringdata_CapacitorBase.data,
      qt_meta_data_CapacitorBase,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CapacitorBase::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CapacitorBase.stringdata0))
        return static_cast<void*>(const_cast< CapacitorBase*>(this));
    if (!strcmp(_clname, "eCapacitor"))
        return static_cast< eCapacitor*>(const_cast< CapacitorBase*>(this));
