...
const QMetaObject InBus::staticMetaObject = {
    { &LogicComponent::staticMetaObject, qt_meta_stringdata_InBus.data,
      qt_meta_data_InBus,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *InBus::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_InBus.stringdata0))
        return static_cast<void*>(const_cast< InBus*>(this));
    if (!strcmp(_clname, "eInBus"))
        return static_cast< eInBus*>(const_cast< InBus*>(this));
