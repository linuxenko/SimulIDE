/****************************************************************************
** Meta object code from reading C++ file 'flipflopd.h'
**
...
#include "../../../src/gui/circuitwidget/components/flipflopd.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'flipflopd.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 35, 11), // "Input_Imped"
QT_MOC_LITERAL(4, 47, 10), // "Out_High_V"
QT_MOC_LITERAL(5, 58, 9), // "Out_Low_V"
QT_MOC_LITERAL(6, 68, 9), // "Out_Imped"
QT_MOC_LITERAL(7, 78, 14), // "Clock_Inverted"
QT_MOC_LITERAL(8, 93, 12) // "S_R_Inverted"

    },
    "FlipFlopD\0Input_High_V\0Input_Low_V\0"
...
void FlipFlopD::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        FlipFlopD *_t = static_cast<FlipFlopD *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
...
const QMetaObject FlipFlopD::staticMetaObject = {
    { &LogicComponent::staticMetaObject, qt_meta_stringdata_FlipFlopD.data,
      qt_meta_data_FlipFlopD,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *FlipFlopD::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FlipFlopD.stringdata0))
        return static_cast<void*>(const_cast< FlipFlopD*>(this));
    if (!strcmp(_clname, "eFlipFlopD"))
        return static_cast< eFlipFlopD*>(const_cast< FlipFlopD*>(this));
