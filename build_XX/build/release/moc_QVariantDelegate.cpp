...
#include "../../../src/gui/QPropertyEditor/QVariantDelegate.h"
...
struct qt_meta_stringdata_QVariantDelegate_t {
    QByteArrayData data[1];
    char stringdata0[17];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QVariantDelegate_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QVariantDelegate_t qt_meta_stringdata_QVariantDelegate = {
    {
QT_MOC_LITERAL(0, 0, 16) // "QVariantDelegate"
...
const QMetaObject QVariantDelegate::staticMetaObject = {
    { &QItemDelegate::staticMetaObject, qt_meta_stringdata_QVariantDelegate.data,
      qt_meta_data_QVariantDelegate,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QVariantDelegate::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QVariantDelegate.stringdata0))
