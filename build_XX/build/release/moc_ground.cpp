...
#include "../../../src/gui/circuitwidget/components/ground.h"
...
void Ground::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Ground *_t = static_cast<Ground *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject Ground::staticMetaObject = {
    { &Component::staticMetaObject, qt_meta_stringdata_Ground.data,
      qt_meta_data_Ground,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Ground::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Ground.stringdata0))
        return static_cast<void*>(const_cast< Ground*>(this));
