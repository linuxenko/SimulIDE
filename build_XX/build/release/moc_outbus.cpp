...
const QMetaObject OutBus::staticMetaObject = {
    { &LogicComponent::staticMetaObject, qt_meta_stringdata_OutBus.data,
      qt_meta_data_OutBus,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *OutBus::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_OutBus.stringdata0))
        return static_cast<void*>(const_cast< OutBus*>(this));
    if (!strcmp(_clname, "eOutBus"))
        return static_cast< eOutBus*>(const_cast< OutBus*>(this));
