...
const QMetaObject CurrSource::staticMetaObject = {
    { &Component::staticMetaObject, qt_meta_stringdata_CurrSource.data,
      qt_meta_data_CurrSource,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CurrSource::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CurrSource.stringdata0))
        return static_cast<void*>(const_cast< CurrSource*>(this));
    if (!strcmp(_clname, "eElement"))
        return static_cast< eElement*>(const_cast< CurrSource*>(this));
