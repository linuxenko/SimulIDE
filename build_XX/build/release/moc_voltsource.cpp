/****************************************************************************
** Meta object code from reading C++ file 'voltsource.h'
**
...
#include "../../../src/gui/circuitwidget/components/voltsource.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'voltsource.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 28, 11), // "voltChanged"
QT_MOC_LITERAL(4, 40, 4), // "volt"
QT_MOC_LITERAL(5, 45, 6), // "remove"
QT_MOC_LITERAL(6, 52, 7), // "Voltage"
QT_MOC_LITERAL(7, 60, 4), // "Unit"
QT_MOC_LITERAL(8, 65, 9) // "Show_Volt"

    },
    "VoltSource\0onbuttonclicked\0\0voltChanged\0"
    "volt\0remove\0Voltage\0Unit\0Show_Volt"
};
...
void VoltSource::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        VoltSource *_t = static_cast<VoltSource *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onbuttonclicked(); break;
        case 1: _t->voltChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
...
const QMetaObject VoltSource::staticMetaObject = {
    { &Component::staticMetaObject, qt_meta_stringdata_VoltSource.data,
      qt_meta_data_VoltSource,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *VoltSource::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_VoltSource.stringdata0))
        return static_cast<void*>(const_cast< VoltSource*>(this));
    if (!strcmp(_clname, "eElement"))
        return static_cast< eElement*>(const_cast< VoltSource*>(this));
