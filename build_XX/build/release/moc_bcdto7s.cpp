...
const QMetaObject BcdTo7S::staticMetaObject = {
    { &LogicComponent::staticMetaObject, qt_meta_stringdata_BcdTo7S.data,
      qt_meta_data_BcdTo7S,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *BcdTo7S::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_BcdTo7S.stringdata0))
        return static_cast<void*>(const_cast< BcdTo7S*>(this));
    if (!strcmp(_clname, "eBcdTo7S"))
        return static_cast< eBcdTo7S*>(const_cast< BcdTo7S*>(this));
