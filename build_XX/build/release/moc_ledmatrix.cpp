...
const QMetaObject LedMatrix::staticMetaObject = {
    { &Component::staticMetaObject, qt_meta_stringdata_LedMatrix.data,
      qt_meta_data_LedMatrix,  qt_static_metacall, qt_meta_extradata_LedMatrix, Q_NULLPTR}
};
...
void *LedMatrix::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_LedMatrix.stringdata0))
        return static_cast<void*>(const_cast< LedMatrix*>(this));
    if (!strcmp(_clname, "eElement"))
        return static_cast< eElement*>(const_cast< LedMatrix*>(this));
