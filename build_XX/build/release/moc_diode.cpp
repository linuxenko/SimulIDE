...
const QMetaObject Diode::staticMetaObject = {
    { &Component::staticMetaObject, qt_meta_stringdata_Diode.data,
      qt_meta_data_Diode,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Diode::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Diode.stringdata0))
        return static_cast<void*>(const_cast< Diode*>(this));
    if (!strcmp(_clname, "eDiode"))
        return static_cast< eDiode*>(const_cast< Diode*>(this));
