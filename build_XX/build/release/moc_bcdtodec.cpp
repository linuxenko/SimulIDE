/****************************************************************************
** Meta object code from reading C++ file 'bcdtodec.h'
**
...
#include "../../../src/gui/circuitwidget/components/bcdtodec.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'bcdtodec.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(7, 77, 8), // "Inverted"
QT_MOC_LITERAL(8, 86, 8) // "Tristate"

    },
    "BcdToDec\0Input_High_V\0Input_Low_V\0"
...
void BcdToDec::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        BcdToDec *_t = static_cast<BcdToDec *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
...
const QMetaObject BcdToDec::staticMetaObject = {
    { &LogicComponent::staticMetaObject, qt_meta_stringdata_BcdToDec.data,
      qt_meta_data_BcdToDec,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *BcdToDec::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_BcdToDec.stringdata0))
        return static_cast<void*>(const_cast< BcdToDec*>(this));
    if (!strcmp(_clname, "eBcdToDec"))
        return static_cast< eBcdToDec*>(const_cast< BcdToDec*>(this));
