/****************************************************************************
** Meta object code from reading C++ file 'volt_reg.h'
**
...
#include "../../../src/gui/circuitwidget/components/volt_reg.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'volt_reg.h' doesn't include <QObject>."
...
void VoltReg::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        VoltReg *_t = static_cast<VoltReg *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< double*>(_v) = _t->vRef(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setVRef(*reinterpret_cast< double*>(_v)); break;
        default: break;
        }
...
const QMetaObject VoltReg::staticMetaObject = {
    { &Component::staticMetaObject, qt_meta_stringdata_VoltReg.data,
      qt_meta_data_VoltReg,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *VoltReg::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_VoltReg.stringdata0))
        return static_cast<void*>(const_cast< VoltReg*>(this));
    if (!strcmp(_clname, "eVoltReg"))
        return static_cast< eVoltReg*>(const_cast< VoltReg*>(this));
