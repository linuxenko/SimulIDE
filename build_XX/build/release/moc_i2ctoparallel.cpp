/****************************************************************************
** Meta object code from reading C++ file 'i2ctoparallel.h'
**
...
#include "../../../src/gui/circuitwidget/components/i2ctoparallel.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'i2ctoparallel.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 14, 12) // "Control_Code"

    },
    "I2CToParallel\0Control_Code"
};
...
void I2CToParallel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        I2CToParallel *_t = static_cast<I2CToParallel *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
...
const QMetaObject I2CToParallel::staticMetaObject = {
    { &LogicComponent::staticMetaObject, qt_meta_stringdata_I2CToParallel.data,
      qt_meta_data_I2CToParallel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *I2CToParallel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_I2CToParallel.stringdata0))
        return static_cast<void*>(const_cast< I2CToParallel*>(this));
    if (!strcmp(_clname, "eI2C"))
        return static_cast< eI2C*>(const_cast< I2CToParallel*>(this));
