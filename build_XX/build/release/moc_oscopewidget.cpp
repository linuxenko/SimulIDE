...
const QMetaObject OscopeWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_OscopeWidget.data,
      qt_meta_data_OscopeWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *OscopeWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_OscopeWidget.stringdata0))
        return static_cast<void*>(const_cast< OscopeWidget*>(this));
    if (!strcmp(_clname, "eElement"))
        return static_cast< eElement*>(const_cast< OscopeWidget*>(this));
