/****************************************************************************
** Meta object code from reading C++ file 'audio_out.h'
**
...
#include "../../../src/gui/circuitwidget/components/audio_out.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'audio_out.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 17, 13), // "OnAudioNotify"
QT_MOC_LITERAL(4, 31, 9) // "Impedance"

    },
    "AudioOut\0remove\0\0OnAudioNotify\0Impedance"
};
...
void AudioOut::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setResSafe(*reinterpret_cast< double*>(_v)); break;
        default: break;
        }
...
const QMetaObject AudioOut::staticMetaObject = {
    { &Component::staticMetaObject, qt_meta_stringdata_AudioOut.data,
      qt_meta_data_AudioOut,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *AudioOut::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "eResistor"))
        return static_cast< eResistor*>(const_cast< AudioOut*>(this));
